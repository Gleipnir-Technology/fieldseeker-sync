...
func (s *FSPointlocationSetter) Apply(q *dialect.InsertQuery) {
	...
	q.AppendValues(bob.ExpressionFunc(func(ctx context.Context, w io.Writer, d bob.Dialect, start int) ([]any, error) {
		...
		if !s.Jurisdiction.IsUnset() {
			vals[11] = psql.Arg(s.Jurisdiction.MustGetNull())
		} else {
			vals[11] = psql.Raw("DEFAULT")
		}

		if !s.Larvinspectinterval.IsUnset() {
			vals[12] = psql.Arg(s.Larvinspectinterval.MustGetNull())
		} else {
			vals[12] = psql.Raw("DEFAULT")
		}

		if !s.Lastinspectactiontaken.IsUnset() {
			vals[13] = psql.Arg(s.Lastinspectactiontaken.MustGetNull())
		} else {
			vals[13] = psql.Raw("DEFAULT")
		}

		if !s.Lastinspectactivity.IsUnset() {
			vals[14] = psql.Arg(s.Lastinspectactivity.MustGetNull())
		} else {
			vals[14] = psql.Raw("DEFAULT")
		}

		if !s.Lastinspectavglarvae.IsUnset() {
			vals[15] = psql.Arg(s.Lastinspectavglarvae.MustGetNull())
		} else {
			vals[15] = psql.Raw("DEFAULT")
		}

		if !s.Lastinspectavgpupae.IsUnset() {
			vals[16] = psql.Arg(s.Lastinspectavgpupae.MustGetNull())
		} else {
			vals[16] = psql.Raw("DEFAULT")
		}

		if !s.Lastinspectbreeding.IsUnset() {
			vals[17] = psql.Arg(s.Lastinspectbreeding.MustGetNull())
		} else {
		...
		if !s.Lastinspectdate.IsUnset() {
			vals[19] = psql.Arg(s.Lastinspectdate.MustGetNull())
		} else {
			vals[19] = psql.Raw("DEFAULT")
		}

		if !s.Lastinspectfieldspecies.IsUnset() {
			vals[20] = psql.Arg(s.Lastinspectfieldspecies.MustGetNull())
		} else {
			vals[20] = psql.Raw("DEFAULT")
		}

		if !s.Lastinspectlstages.IsUnset() {
			vals[21] = psql.Arg(s.Lastinspectlstages.MustGetNull())
		} else {
			vals[21] = psql.Raw("DEFAULT")
		}

		if !s.Lasttreatactivity.IsUnset() {
			vals[22] = psql.Arg(s.Lasttreatactivity.MustGetNull())
		} else {
			vals[22] = psql.Raw("DEFAULT")
		}

		if !s.Lasttreatdate.IsUnset() {
			vals[23] = psql.Arg(s.Lasttreatdate.MustGetNull())
		} else {
			vals[23] = psql.Raw("DEFAULT")
		}

		if !s.Lasttreatproduct.IsUnset() {
			vals[24] = psql.Arg(s.Lasttreatproduct.MustGetNull())
		} else {
			vals[24] = psql.Raw("DEFAULT")
		}

		if !s.Lasttreatqty.IsUnset() {
			vals[25] = psql.Arg(s.Lasttreatqty.MustGetNull())
		} else {
			vals[25] = psql.Raw("DEFAULT")
		}

		if !s.Lasttreatqtyunit.IsUnset() {
			vals[26] = psql.Arg(s.Lasttreatqtyunit.MustGetNull())
		} else {
			vals[26] = psql.Raw("DEFAULT")
		}

		if !s.Locationnumber.IsUnset() {
			vals[27] = psql.Arg(s.Locationnumber.MustGetNull())
		} else {
			vals[27] = psql.Raw("DEFAULT")
		}

		if !s.Name.IsUnset() {
			vals[28] = psql.Arg(s.Name.MustGetNull())
		} else {
			vals[28] = psql.Raw("DEFAULT")
		}

		if !s.Nextactiondatescheduled.IsUnset() {
			vals[29] = psql.Arg(s.Nextactiondatescheduled.MustGetNull())
		} else {
		...
		if !s.Priority.IsUnset() {
			vals[31] = psql.Arg(s.Priority.MustGetNull())
		} else {
			vals[31] = psql.Raw("DEFAULT")
		}

		if !s.Stype.IsUnset() {
			vals[32] = psql.Arg(s.Stype.MustGetNull())
		} else {
			vals[32] = psql.Raw("DEFAULT")
		}

		if !s.Symbology.IsUnset() {
			vals[33] = psql.Arg(s.Symbology.MustGetNull())
		} else {
			vals[33] = psql.Raw("DEFAULT")
		}

		if !s.Usetype.IsUnset() {
			vals[34] = psql.Arg(s.Usetype.MustGetNull())
		} else {
			vals[34] = psql.Raw("DEFAULT")
		}

		if !s.Waterorigin.IsUnset() {
			vals[35] = psql.Arg(s.Waterorigin.MustGetNull())
		} else {
			vals[35] = psql.Raw("DEFAULT")
		}

		if !s.X.IsUnset() {
			vals[36] = psql.Arg(s.X.MustGetNull())
		} else {
			vals[36] = psql.Raw("DEFAULT")
		}

		if !s.Y.IsUnset() {
			vals[37] = psql.Arg(s.Y.MustGetNull())
		} else {
			vals[37] = psql.Raw("DEFAULT")
		}

		if !s.Zone.IsUnset() {
			vals[38] = psql.Arg(s.Zone.MustGetNull())
		} else {
			vals[38] = psql.Raw("DEFAULT")
		}

		if !s.Zone2.IsUnset() {
			vals[39] = psql.Arg(s.Zone2.MustGetNull())
		} else {
			vals[39] = psql.Raw("DEFAULT")
		}

		if !s.GeometryX.IsUnset() {
			vals[40] = psql.Arg(s.GeometryX.MustGetNull())
		} else {
			vals[40] = psql.Raw("DEFAULT")
		}

		if !s.GeometryY.IsUnset() {
			vals[41] = psql.Arg(s.GeometryY.MustGetNull())
		} else {
			vals[41] = psql.Raw("DEFAULT")
		}

		if !s.Assignedtech.IsUnset() {
			vals[42] = psql.Arg(s.Assignedtech.MustGetNull())
		} else {
			vals[42] = psql.Raw("DEFAULT")
		}

		if !s.DeactivateReason.IsUnset() {
			vals[43] = psql.Arg(s.DeactivateReason.MustGetNull())
		} else {
			vals[43] = psql.Raw("DEFAULT")
		}

		if !s.Scalarpriority.IsUnset() {
			vals[44] = psql.Arg(s.Scalarpriority.MustGetNull())
		} else {
			vals[44] = psql.Raw("DEFAULT")
		}

		if !s.Sourcestatus.IsUnset() {
			vals[45] = psql.Arg(s.Sourcestatus.MustGetNull())
		} else {
			vals[45] = psql.Raw("DEFAULT")
		}

		if s.Updated.IsValue() {
			vals[46] = psql.Arg(s.Updated.MustGet())
		} else {
